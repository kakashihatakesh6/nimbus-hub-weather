...
const WeatherHour = (props) => {
  ...
  return (
    <div className='mt-5'>
      ...
      {data && cwdata && <div className={`card my-2 container ${styles.weatherBox} ${isActive ? `${styles.active}` : ''}`} style={{visibility: `${showBox}? "hidden": "visible"`}} id="weather-box" ref={myRef}>
